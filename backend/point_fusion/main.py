...
if __name__ == '__main__':
    ...
    m = Map()  # store points in world frame
    ...
    # i.e., the first camera's pose in the world frame
    ...
    for i in range(args.start_idx, args.end_idx + 1):
        ...
        if i > 1:
            ...
            T_world_to_cam = icp(m.points[::down_factor],  # world frame
                                 m.normals[::down_factor],
                                 vertex_map,  # camera frame
                                 normal_map,
                                 intrinsic,
                                 T_world_to_cam,
        ...
        m.fuse(vertex_map, normal_map, color_map, intrinsic, T_cam_to_world)  # fuse without removing points 
        # m.fuse_bonus(vertex_map, normal_map, color_map, intrinsic, T_cam_to_world, i, c_stable=8, t_max=40) # fuse with removing points
